...
public partial class MainWindow : Window
{
    ...
    public MainWindow()
    {
        ...
        SetupAutoCompletes();
        Loaded += (_, _) => { InitNavigation(); ApplyAvailableModules(); InitModsAutoCompletes(); WireUpUndoRedo(); WireUpKeyBindings(); AutoLoadFromGmConfig(); };
    }

    private void ApplyAvailableModules()
    {
        Nav_Recipes.Visibility = GmPathService.HasRecipes ? Visibility.Visible : Visibility.Collapsed;
        Nav_GmConfig.Visibility = GmPathService.HasCraftTable ? Visibility.Visible : Visibility.Collapsed;
    
        Nav_Quests.Visibility = GmPathService.HasQuests ? Visibility.Visible : Visibility.Collapsed;
    
        Nav_NPC.Visibility =
        Nav_Loot.Visibility =
        Nav_Triggers.Visibility =
        Nav_Player.Visibility = GmPathService.HasQuestSystem ? Visibility.Visible : Visibility.Collapsed;
    
        Nav_Medicine.Visibility =
        Nav_Ability.Visibility = GmPathService.HasAbility ? Visibility.Visible : Visibility.Collapsed;
    
        Nav_Liquid.Visibility =
        Nav_Food.Visibility = GmPathService.HasFood ? Visibility.Visible : Visibility.Collapsed;
    
        Nav_MineRock.Visibility =
        Nav_RockPoints.Visibility = GmPathService.HasMineRock ? Visibility.Visible : Visibility.Collapsed;
    }
